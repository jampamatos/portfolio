...
function createWindow(title: string, content: string) {
    ...
    // Menu links (if any)
    const menuAbout = windowElement.querySelector('#menu-about') as HTMLElement;
    const menuProjects = windowElement.querySelector('#menu-projects') as HTMLElement;
    const menuContact = windowElement.querySelector('#menu-contact') as HTMLElement;
